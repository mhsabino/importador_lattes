  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_banca_julgadora != None:
        ...
        banca_julgadora_para_concurso_publicos = participacao_em_banca_julgadora.findall('BANCA-JULGADORA-PARA-CONCURSO-PUBLICO')

        for banca_julgadora_para_concurso_publico in banca_julgadora_para_concurso_publicos:

          dados_basicos         = banca_julgadora_para_concurso_publico.find('DADOS-BASICOS-DA-BANCA-JULGADORA-PARA-CONCURSO-PUBLICO')
          detalhamento          = banca_julgadora_para_concurso_publico.find('DETALHAMENTO-DA-BANCA-JULGADORA-PARA-CONCURSO-PUBLICO')
          palavras_chave        = banca_julgadora_para_concurso_publico.find('PALAVRAS-CHAVE')
          participantes         = banca_julgadora_para_concurso_publico.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = banca_julgadora_para_concurso_publico.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = banca_julgadora_para_concurso_publico.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Banco julgadora avaliacao curso inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Banco julgadora avaliacao curso')
            print(e)
