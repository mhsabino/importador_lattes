  ...
  try:
    ...
    if producao_tecnica != None:
      ...
      if demais_tipos_de_producao_tecnica_grupo != None:
        ...
        curso_de_curta_duracao_ministrados = demais_tipos_de_producao_tecnica_grupo.findall('CURSO-DE-CURTA-DURACAO-MINISTRADO')

        for curso_de_curta_duracao_ministrado in curso_de_curta_duracao_ministrados:

          dados_basicos_do_curso_de_curta_duracao_ministrado = curso_de_curta_duracao_ministrado.find('DADOS-BASICOS-DE-CURSOS-CURTA-DURACAO-MINISTRADO')
          detalhamento_do_curso_de_curta_duracao_ministrado  = curso_de_curta_duracao_ministrado.find('DETALHAMENTO-DE-CURSOS-CURTA-DURACAO-MINISTRADO')
          palavras_chave                                     = curso_de_curta_duracao_ministrado.find('PALAVRAS-CHAVE')
          autores                                            = curso_de_curta_duracao_ministrado.findall('AUTORES')
          areas_do_conhecimento                              = curso_de_curta_duracao_ministrado.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade                               = curso_de_curta_duracao_ministrado.find('SETORES-DE-ATIVIDADE')

          if dados_basicos_do_curso_de_curta_duracao_ministrado != None:

            nivel_do_curso     = texto.normaliza(dados_basicos_do_curso_de_curta_duracao_ministrado.get('NIVEL-DO-CURSO') or '')
            titulo             = texto.normaliza(dados_basicos_do_curso_de_curta_duracao_ministrado.get('TITULO') or '')
            ano                = texto.normaliza(dados_basicos_do_curso_de_curta_duracao_ministrado.get('ANO') or '')
            pais               = texto.normaliza(dados_basicos_do_curso_de_curta_duracao_ministrado.get('PAIS') or '')
            idioma             = texto.normaliza(dados_basicos_do_curso_de_curta_duracao_ministrado.get('IDIOMA') or '')
            meio_de_divulgacao = texto.normaliza(dados_basicos_do_curso_de_curta_duracao_ministrado.get('MEIO-DE-DIVULGACAO') or '')


          if detalhamento_do_curso_de_curta_duracao_ministrado != None:

            participacao_dos_autores       = texto.normaliza(detalhamento_do_curso_de_curta_duracao_ministrado.get('PARTICIPACAO-DOS-AUTORES') or '')
            instituicao_promotora_do_curso = texto.normaliza(detalhamento_do_curso_de_curta_duracao_ministrado.get('INSTITUICAO-PROMOTORA-DO-CURSO') or '')
            local_do_curso                 = texto.normaliza(detalhamento_do_curso_de_curta_duracao_ministrado.get('LOCAL-DO-CURSO') or '')
