  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_eventos_congressos != None:
        ...
        participacao_em_encontros = participacao_em_eventos_congressos.findall('PARTICIPACAO-EM-ENCONTRO')

        for participacao_em_encontro in participacao_em_encontros:

          dados_basicos         = participacao_em_encontro.find('DADOS-BASICOS-DA-PARTICIPACAO-EM-ENCONTRO')
          detalhamento          = participacao_em_encontro.find('DETALHAMENTO-DA-PARTICIPACAO-EM-ENCONTRO')
          palavras_chave        = participacao_em_encontro.find('PALAVRAS-CHAVE')
          participantes         = participacao_em_encontro.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = participacao_em_encontro.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = participacao_em_encontro.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Participacao em encontro inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Participacao em encontro')
            print(e)
