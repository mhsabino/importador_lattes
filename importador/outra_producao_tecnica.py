  ...
  try:
    ...
    if producao_tecnica != None:
      ...
      if demais_tipos_de_producao_tecnica_grupo != None:
        ...
        outra_producao_tecnicas = demais_tipos_de_producao_tecnica_grupo.findall('OUTRA-PRODUCAO-TECNICA')

        for outra_producao_tecnica in outra_producao_tecnicas:

          dados_basicos         = outra_producao_tecnica.find('DADOS-BASICOS-DE-OUTRA-PRODUCAO-TECNICA')
          detalhamento          = outra_producao_tecnica.find('DETALHAMENTO-DE-OUTRA-PRODUCAO-TECNICA')
          palavras_chave        = outra_producao_tecnica.find('PALAVRAS-CHAVE')
          autores               = outra_producao_tecnica.findall('AUTORES')
          areas_do_conhecimento = outra_producao_tecnica.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = outra_producao_tecnica.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            print('ERRO: Ao salvar o Outra producao tecnica')
            print(e)
