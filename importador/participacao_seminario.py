  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_eventos_congressos != None:
        ...
        participacao_em_seminarios = participacao_em_eventos_congressos.findall('PARTICIPACAO-EM-SEMINARIO')

        for participacao_em_seminario in participacao_em_seminarios:

          dados_basicos         = participacao_em_seminario.find('DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO')
          detalhamento          = participacao_em_seminario.find('DETALHAMENTO-DA-PARTICIPACAO-EM-SEMINARIO')
          palavras_chave        = participacao_em_seminario.find('PALAVRAS-CHAVE')
          participantes         = participacao_em_seminario.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = participacao_em_seminario.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = participacao_em_seminario.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Participacao em seminario inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Participacao em seminario')
            print(e)
