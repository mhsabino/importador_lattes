  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_banca_julgadora != None:
        ...
        banca_julgadora_para_livre_docencias = participacao_em_banca_julgadora.findall('BANCA-JULGADORA-PARA-LIVRE-DOCENCIA')

        for banca_julgadora_para_livre_docencia in banca_julgadora_para_livre_docencias:

          dados_basicos         = banca_julgadora_para_livre_docencia.find('DADOS-BASICOS-DA-BANCA-JULGADORA-PARA-LIVRE-DOCENCIA')
          detalhamento          = banca_julgadora_para_livre_docencia.find('DETALHAMENTO-DA-BANCA-JULGADORA-PARA-LIVRE-DOCENCIA')
          palavras_chave        = banca_julgadora_para_livre_docencia.find('PALAVRAS-CHAVE')
          participantes         = banca_julgadora_para_livre_docencia.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = banca_julgadora_para_livre_docencia.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = banca_julgadora_para_livre_docencia.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Banco julgadora livre docencia inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Banco julgadora livre docencia')
            print(e)
