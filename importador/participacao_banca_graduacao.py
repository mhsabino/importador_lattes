  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_banca_trabalhos_conclusao != None:
        ...
        participacao_em_banca_de_graduacoes = participacao_em_banca_trabalhos_conclusao.findall('PARTICIPACAO-EM-BANCA-DE-GRADUACAO')

        for participacao_em_banca_de_graduacao in participacao_em_banca_de_graduacoes:

          dados_basicos         = participacao_em_banca_de_graduacao.find('DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO')
          detalhamento          = participacao_em_banca_de_graduacao.find('DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO')
          palavras_chave        = participacao_em_banca_de_graduacao.find('PALAVRAS-CHAVE')
          participantes         = participacao_em_banca_de_graduacao.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = participacao_em_banca_de_graduacao.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = participacao_em_banca_de_graduacao.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Participacao graduacao inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Participacao graduacao')
            print(e)
