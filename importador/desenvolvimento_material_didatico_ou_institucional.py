  ...
  try:
    ...
    if producao_tecnica != None:
      ...
      if demais_tipos_de_producao_tecnica_grupo != None:
        ...
        desenvolvimento_de_material_didatico_ou_instrucionals = demais_tipos_de_producao_tecnica_grupo.findall('DESENVOLVIMENTO-DE-MATERIAL-DIDATICO-OU-INSTRUCIONAL')

        for desenvolvimento_de_material_didatico_ou_instrucional in desenvolvimento_de_material_didatico_ou_instrucionals:

          dados_basicos         = desenvolvimento_de_material_didatico_ou_instrucional.find('DADOS-BASICOS-DO-MATERIAL-DIDATICO-OU-INSTRUCIONAL')
          detalhamento          = desenvolvimento_de_material_didatico_ou_instrucional.find('DETALHAMENTO-DO-MATERIAL-DIDATICO-OU-INSTRUCIONAL')
          palavras_chave        = desenvolvimento_de_material_didatico_ou_instrucional.find('PALAVRAS-CHAVE')
          autores               = desenvolvimento_de_material_didatico_ou_instrucional.findall('AUTORES')
          areas_do_conhecimento = desenvolvimento_de_material_didatico_ou_instrucional.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = desenvolvimento_de_material_didatico_ou_instrucional.find('SETORES-DE-ATIVIDADE')
