  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_banca_trabalhos_conclusao != None:
        ...
        participacao_em_banca_de_mestrados = participacao_em_banca_trabalhos_conclusao.findall('PARTICIPACAO-EM-BANCA-DE-MESTRADO')

        for participacao_em_banca_de_mestrado in participacao_em_banca_de_mestrados:

          dados_basicos         = participacao_em_banca_de_mestrado.find('DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-MESTRADO')
          detalhamento          = participacao_em_banca_de_mestrado.find('DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-MESTRADO')
          palavras_chave        = participacao_em_banca_de_mestrado.find('PALAVRAS-CHAVE')
          participantes         = participacao_em_banca_de_mestrado.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = participacao_em_banca_de_mestrado.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = participacao_em_banca_de_mestrado.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Participacao mestrado inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Participacao mestrado')
            print(e)
