  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_eventos_congressos != None:
        ...
        outras_participacoes_em_eventos_congressos = participacao_em_eventos_congressos.findall('OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS')

        for outras_participacoes_em_eventos_congresso in outras_participacoes_em_eventos_congressos:

          dados_basicos         = outras_participacoes_em_eventos_congresso.find('DADOS-BASICOS-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS')
          detalhamento          = outras_participacoes_em_eventos_congresso.find('DETALHAMENTO-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS')
          palavras_chave        = outras_participacoes_em_eventos_congresso.find('PALAVRAS-CHAVE')
          participantes         = outras_participacoes_em_eventos_congresso.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = outras_participacoes_em_eventos_congresso.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = outras_participacoes_em_eventos_congresso.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Outra participacao em evento congresso inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Outra participacao em evento congresso')
            print(e)
