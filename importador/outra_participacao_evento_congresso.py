  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_eventos_congressos != None:
        ...
        participacao_em_eventos = participacao_em_eventos_congressos.findall('OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS')

        for participacao_em_evento in participacao_em_eventos:

          dados_basicos         = participacao_em_evento.find('DADOS-BASICOS-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS')
          detalhamento          = participacao_em_evento.find('DETALHAMENTO-DE-OUTRAS-PARTICIPACOES-EM-EVENTOS-CONGRESSOS')
