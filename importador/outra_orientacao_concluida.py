  ...
  try:
    ...
    if outra_producao != None:
      ...
      if orientacoes_concluidas_grupo != None:
        ...
        orientacoes_concluidas_para_doutorados = orientacoes_concluidas_grupo.findall('OUTRAS-ORIENTACOES-CONCLUIDAS')

        for relatorio_de_pesquisa in orientacoes_concluidas_para_doutorados:

          dados_basicos         = relatorio_de_pesquisa.find('DADOS-BASICOS-DE-OUTRAS-ORIENTACOES-CONCLUIDAS')
          detalhamento          = relatorio_de_pesquisa.find('DETALHAMENTO-DE-OUTRAS-ORIENTACOES-CONCLUIDAS')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Outra orientacao inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Outra orientacao')
            print(e)
