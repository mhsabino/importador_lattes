  ...
  try:
    ...
    if producao_tecnica != None:
      ...
      if demais_tipos_de_producao_tecnica_grupo != None:
        ...
        organizacao_de_eventos = demais_tipos_de_producao_tecnica_grupo.findall('ORGANIZACAO-DE-EVENTO')

        for organizacao_de_evento in organizacao_de_eventos:

          dados_basicos         = organizacao_de_evento.find('DADOS-BASICOS-DA-ORGANIZACAO-DE-EVENTO')
          detalhamento          = organizacao_de_evento.find('DETALHAMENTO-DA-ORGANIZACAO-DE-EVENTO')
          palavras_chave        = organizacao_de_evento.find('PALAVRAS-CHAVE')
          autores               = organizacao_de_evento.findall('AUTORES')
          areas_do_conhecimento = organizacao_de_evento.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = organizacao_de_evento.find('SETORES-DE-ATIVIDADE')
