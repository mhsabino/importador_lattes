  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_banca_julgadora != None:
        ...
        banca_julgadora_para_avaliacao_cursos = participacao_em_banca_julgadora.findall('BANCA-JULGADORA-PARA-AVALIACAO-CURSOS')

        for banca_julgadora_para_avaliacao_curso in banca_julgadora_para_avaliacao_cursos:

          dados_basicos         = banca_julgadora_para_avaliacao_curso.find('DADOS-BASICOS-DA-BANCA-JULGADORA-PARA-AVALIACAO-CURSOS')
          detalhamento          = banca_julgadora_para_avaliacao_curso.find('DETALHAMENTO-DA-BANCA-JULGADORA-PARA-AVALIACAO-CURSOS')
          palavras_chave        = banca_julgadora_para_avaliacao_curso.find('PALAVRAS-CHAVE')
          participantes         = banca_julgadora_para_avaliacao_curso.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = banca_julgadora_para_avaliacao_curso.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = banca_julgadora_para_avaliacao_curso.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Banco julgadora concurso publico inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Banco julgadora concurso publico')
            print(e)
