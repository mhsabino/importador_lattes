  ...
  try:
    ...
    if outra_producao != None:
      ...
      if orientacoes_concluidas_grupo != None:
        ...
        orientacoes_concluidas_para_mestrados = orientacoes_concluidas_grupo.findall('ORIENTACOES-CONCLUIDAS-PARA-MESTRADO')

        for relatorio_de_pesquisa in orientacoes_concluidas_para_mestrados:

          dados_basicos         = relatorio_de_pesquisa.find('DADOS-BASICOS-DE-ORIENTACOES-CONCLUIDAS-PARA-MESTRADO')
          detalhamento          = relatorio_de_pesquisa.find('DETALHAMENTO-DE-ORIENTACOES-CONCLUIDAS-PARA-MESTRADO')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Orientacao mestrado inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Orientacao mestrado')
            print(e)
