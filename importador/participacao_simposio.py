  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_eventos_congressos != None:
        ...
        participacao_em_simposios = participacao_em_eventos_congressos.findall('PARTICIPACAO-EM-SIMPOSIO')

        for participacao_em_simposio in participacao_em_simposios:

          dados_basicos         = participacao_em_simposio.find('DADOS-BASICOS-DA-PARTICIPACAO-EM-SIMPOSIO')
          detalhamento          = participacao_em_simposio.find('DETALHAMENTO-DA-PARTICIPACAO-EM-SIMPOSIO')
          palavras_chave        = participacao_em_simposio.find('PALAVRAS-CHAVE')
          participantes         = participacao_em_simposio.findall('PARTICIPANTE-BANCA')
          areas_do_conhecimento = participacao_em_simposio.find('AREAS-DO-CONHECIMENTO')
          setores_de_atividade  = participacao_em_simposio.find('SETORES-DE-ATIVIDADE')
          ...
          try:
            ...
            conexao.conn.commit()
            print('Participacao em simposio inserida com sucesso!')
          except Exception as e:
            print('ERRO: Ao salvar o Participacao em simposio')
            print(e)
