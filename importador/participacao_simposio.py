  ...
  try:
    ...
    if dados_complementares != None:
      ...
      if participacao_em_eventos_congressos != None:
        ...
        participacao_em_eventos = participacao_em_eventos_congressos.findall('PARTICIPACAO-EM-SIMPOSIO')

        for participacao_em_evento in participacao_em_eventos:

          dados_basicos         = participacao_em_evento.find('DADOS-BASICOS-DA-PARTICIPACAO-EM-SIMPOSIO')
          detalhamento          = participacao_em_evento.find('DETALHAMENTO-DA-PARTICIPACAO-EM-SIMPOSIO')
